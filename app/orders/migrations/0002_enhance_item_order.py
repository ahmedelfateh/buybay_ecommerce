...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='item',
            name='category',
            field=models.CharField(choices=[('SH', 'Shirt'), ('SW', 'Sport Wear'), ('OW', 'Out Wear')], default='SH', max_length=2, verbose_name='Category'),
        ),
        migrations.AddField(
            model_name='item',
            name='description',
        ...
        migrations.AddField(
            model_name='item',
            name='label',
            field=models.CharField(choices=[('PR', 'primary'), ('SE', 'secondary'), ('DA', 'danger')], default='PR', max_length=2, verbose_name='Label'),
        ),
        migrations.AddField(
